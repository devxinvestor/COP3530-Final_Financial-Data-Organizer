To run the code, execute the main.py file. It will prompt you to enter ticker symbols in all caps. If you want to stop entering ticker symbols, type -1 and press Enter.
